...
export default function Home() {
  ...
  return (
    ...
    <FormControl isInvalid={touched.subject && !values.subject} isRequired mb={5}>
      ...
      <Input type="text" name="subject" errorBorderColor="red.300" value={values.subject} onChange={handleChange} onBlur={onBlur} />
      <FormErrorMessage>Required</FormErrorMessage>
    </FormControl>

    <FormControl isInvalid={touched.message && !values.message} isRequired mb={5}>
      <FormLabel>Message</FormLabel>
      <Textarea name="message" errorBorderColor="red.300" value={values.message} rows={4} onChange={handleChange} onBlur={onBlur} />
      <FormErrorMessage>Required</FormErrorMessage>
    </FormControl>
